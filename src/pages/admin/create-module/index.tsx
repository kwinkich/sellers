	...
	return (
		<div className="px-2 min-h-full flex flex-col pb-24 pt-6 gap-6">
				...
				{formData.testVariant === "QUIZ" && (
					<div className="space-y-4 border rounded-lg p-4 bg-gray-50">
						<div className="w-full">
							<HeadText head="Тест" label="Настройте тест для модуля" className="px-2 mb-4" variant="black-black"/>
							<Button
								type="button"
								className="w-full"
								size="xs"
								...
								disabled={createModuleMutation.isPending || createQuizMutation.isPending}
							>
								Добавить вопрос
							</Button>
						</div>
			...
			<Button
				type="submit"
				className="w-full"
				disabled={!isFormValid || createModuleMutation.isPending || createQuizMutation.isPending}
			>
