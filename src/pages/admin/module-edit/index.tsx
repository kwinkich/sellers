    ...
    <div className="min-h-full pb-24">
      ...
      <div className="w-full bg-base-bg rounded-b-3xl px-3 py-4 mb-6">
        ...
        <Button
          onClick={() =>
            navigate(
              `/admin/content/courses/${module.courseId}/modules/${moduleId}/lessons/create`
            )
          }
          className="w-full"
          size="xs"
              ...
              >
                ...
                <div className="flex gap-2 w-full">
                  <Button
                    ...
                    onClick={() =>
                      navigate(
                        `/admin/content/courses/${module.courseId}/modules/${lesson.moduleId}/lessons/${lesson.id}/edit`
                      )
                    }
                  >
                  ...
                  {module.testVariant !== "NONE" && (
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/admin/content/courses/${module.courseId}/modules/${lesson.moduleId}/lessons/${lesson.id}/quizzes/create`
                        )
                      }
                    >
                      Тест
      ...
      <ConfirmationDialog
        ...
        onConfirm={() =>
          confirmState.lessonId && deleteLesson(confirmState.lessonId)
        }
        title="Удалить урок"
